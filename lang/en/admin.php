...
$string['testoutgoingmailconf_suspended'] = 'The user account associated with this email address is suspended. All outgoing mail to suspended user accounts is discarded.';
