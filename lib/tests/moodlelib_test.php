...
EOF;
    ...
    public function test_email_to_user(): void {
        ...
        $sink = $this->redirectEmails();
        email_to_user($user1, $user2, $subject, $messagetext);
        $this->assertDebuggingCalled("email_to_user: User $user1->id (".fullname($user1).") is over bounce threshold! Not sending.");
        $result = $sink->get_messages();
     ...
     * @return array
     */
    public function email_bounce_threshold_provider(): array {
