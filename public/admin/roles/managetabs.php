...
$toprow[] = new tabobject('assignments', new moodle_url('/admin/roles/assignments.php'), get_string('roleassignments', 'role'));
$toprow[] = new tabobject('overrides', new moodle_url('/admin/roles/overrides.php'), get_string('roleoverrides', 'role'));
