...
$string['testoutgoingmailconf_suspended'] = 'The user associated with this email address {$a->profilelink} is suspended. All outgoing mail to suspended user accounts is discarded.';
$string['testoutgoingmailconf_toemail'] = 'To email address';
$string['testoutgoingmailconf_toemailuser'] = 'Auto detect user';
$string['testoutgoingmailconf_toemailuser_help'] = 'If checked and the to email matches with a Moodle account, the email will be sent using that users preferences and context. If unchecked or no matches are found, this will send a raw email that ignores all context and preferences.';
