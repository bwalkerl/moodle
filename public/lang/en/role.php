...
$string['editpermissions'] = 'Edit permissions';
...
$string['risks'] = 'Risks';
$string['risksfilter'] = 'Showing subset of allowed capabilities which have the "{$a->riskname}". <a href="{$a->reseturl}">Reset filter</a>';
...
$string['roleassignments_help'] = 'The number of users assigned this role in this context. Users assigned this role in higher contexts share the same permissions in this context.';
...
$string['rolerisks_help'] = 'The risks associated with this role for this context. Role overrides in lower contexts may introduce additional risks.';
