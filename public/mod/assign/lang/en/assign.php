...
$string['assign:managemarkedallocations'] = 'Manage markers allocated to submissions after they have marked';
...
$string['changeallocatedmarkersaftergrade'] = 'Some selected users have agreed grades that may be updated if allocated markers are changed.';
$string['changemultimarkingmethodconfirm'] = 'Changing the calculation method will update the agreed grade for all students. Continue?';
...
$string['enableoptionalmarkeraftergraded'] = 'Enabling a new optional marker will clear the current grade.';
...
$string['eventmarkeradded'] = 'Marker allocated';
$string['eventmarkerenabledupdated'] = 'Marker enabled status updated';
$string['eventmarkerremoved'] = 'Marker unallocated';
...
$string['eventsubmissionmarked'] = 'The submission has been marked.';
...
$string['markercount'] = 'Maximum total markers';
$string['markercount_help'] = 'The maximum number of total markers for the assignment. Includes both required and optional markers.';
$string['markercountdecreasevalidation'] = 'Cannot reduce total marker count as it will remove a marker who has marked.';
...
$string['maxmarkercount'] = 'Maximum total markers';
$string['maxmarkercount_help'] = 'The maximum number of total markers that can be selected for an assignment.';
$string['maxoptionalmarkercount'] = 'Maximum optional markers';
$string['maxoptionalmarkercount_help'] = 'Maximum number of optional markers that can be selected for an assignment.';
...
$string['optionalmarkercount'] = 'Number of optional markers limit';
$string['optionalmarkercount_help'] = 'The number of optional markers limit for the assignment.';
$string['optionalmarkercountvalidation'] = 'The number of optional markers must be less than the total number of markers.';
$string['optionalmarkercountincreasevalidation'] = 'Cannot increase optional marker count as a minimum required marker has already marked.';
