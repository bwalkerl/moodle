...
Feature: Assignment multimarking settings
  ...
  Scenario: Changing settings that recalculate grades from marks give a warning
    ...
    # Enable multi marking with existing grades.
    And I navigate to "Settings" in current page administration
    And I expand all fieldsets
    And I set the field "Use marking workflow" to "Yes"
    And I set the field "Use marking allocation" to "Yes"
    And I set the field "Maximum total markers" to "2"
    And I set the field "Number of optional markers limit" to "3"
    And I press "Save and display"
    Then "#id_error_optionalmarkercount" "css_element" should be visible
    And I set the field "Number of optional markers limit" to "0"
    And I press "Save and display"
    ...
    And I press "Save and display"
    And I wait until "Continue" "button" exists
    And I should see "Changing the calculation method"
