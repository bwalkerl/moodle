...
final class provider_test extends provider_testcase {
    ...
    public function test_export_user_data_student(): void {
        ...
        $assign->update_allocated_markers($user->id, [1 => $teacher->id]);
    ...
    public function test_export_user_data_teacher(): void {
        ...
        $assign->update_allocated_markers($user1->id, [1 => $teacher->id]);
        ...
        // Allocate the teacher as a marker on the assignment.
        $assign->update_allocated_markers($user2->id, [1 => $teacher->id]);
    ...
    public function test_delete_data_for_users(): void {
        ...
        foreach ([$assign1, $assign2] as $assign) {
            foreach ([$user1, $user2, $user6] as $user) {
                $assign->update_allocated_markers($user->id, [1 => $user5->id]);
            }
        }
